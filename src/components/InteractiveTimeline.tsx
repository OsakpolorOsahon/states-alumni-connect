  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      <div className="relative">
        {/* Timeline Line */}
        <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-[#E10600] to-[#E10600]/30 rounded-full"></div>
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 z-10">
                  <motion.button
                    ...
                    className={`w-16 h-16 rounded-full ${item.color} flex items-center justify-center shadow-lg border-4 border-background dark:border-background`}
                  >
                  ...
                  <Card className="bg-card dark:bg-card border border-border dark:border-border hover:shadow-lg transition-all duration-300">
                    <CardContent className="p-6">
                      <div className="flex items-center mb-3">
                        <span className="text-2xl font-bold text-[#E10600] mr-3">
                          {item.year}
                        </span>
                      </div>
